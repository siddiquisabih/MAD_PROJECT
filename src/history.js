        ...
        return (
            <SafeAreaView style={{ flex: 1, backgroundColor: "#2279a4", paddingTop: 20 }}>
                ...
                <View style={{ borderWidth: 1, paddingVertical: 20, marginHorizontal: 20, borderRadius: 10, borderColor: "lightgray" }}>
                    ...
                    <Text style={{ color: "white", textAlign: "center", paddingBottom: 5 }}>History</Text>
                                ...
                                {this.state.usersMonths.map((m, v) => {
                                    ...
                                    return (
                                        <View style={{ padding: 10 }}>
                                            ...
                                            {
                                                m.month.hasOwnProperty("detail") ?

                                                    m.month.detail.map((j, k) => {
                                                        return (
                                                            <Text style={[{ paddingBottom: 3, color: "white" },]}  >Rs.{j.expense}  {m.month.name}</Text>
